...
- (instancetype)init {
    ...
    if (self) {
        ...
        UIImageView *touchImageView = [[UIImageView alloc]initWithFrame:CGRectMake(ScreenWidth/2 - kAUTOWIDTH(70)/2, PCTopBarHeight + kAUTOHEIGHT(50), kAUTOWIDTH(70), kAUTOWIDTH(70))];
        
        [_vc.view addSubview:touchImageView];
        touchImageView.image = [UIImage imageNamed:@"iconNew1024.png"];
        _vc.view.backgroundColor = [UIColor whiteColor];
        touchImageView.contentMode = UIViewContentModeScaleAspectFill;
       
        touchImageView.layer.cornerRadius = kAUTOHEIGHT(12);
        touchImageView.layer.masksToBounds = YES;
        CALayer *subLayer=[CALayer layer];
        CGRect fixframe=touchImageView.layer.frame;
        subLayer.frame = fixframe;
        subLayer.cornerRadius = kAUTOHEIGHT(12);
