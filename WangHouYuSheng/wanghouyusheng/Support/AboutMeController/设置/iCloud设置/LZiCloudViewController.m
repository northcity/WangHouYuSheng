...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        ...
        cell.textLabel.font = PNCisIPAD ?  [UIFont fontWithName:@"HeiTi SC" size:(15)] : [UIFont fontWithName:@"HeiTi SC" size:kAUTOWIDTH(12)];
    }
...
//            _shiJianChaLabel.text = [NSString stringWithFormat:@"%@秒前自动同步",[text substringToIndex:5]];
            ...
            cell.imageView.image = [UIImage imageNamed:@"云上传"];
        ...
        cell.imageView.image = [UIImage imageNamed:@"云下载"];
