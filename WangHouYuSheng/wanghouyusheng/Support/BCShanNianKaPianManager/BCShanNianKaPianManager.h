...
typedef NS_ENUM(NSUInteger, BCShanNianKaPianManagerColorString) {
    BCShanNianKaPianManagerColorString1 =52,
    BCShanNianKaPianManagerColorString2,
    BCShanNianKaPianManagerColorString3,
    BCShanNianKaPianManagerColorString4,
    BCShanNianKaPianManagerColorString5
};
