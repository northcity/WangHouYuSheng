...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        if (PNCisIPAD) {
        _label.frame = CGRectMake((10), (5), ScreenWidth - (20), (50));
        }
        ...
        self.vipImageView =  PNCisIPAD ? [[UIImageView alloc]initWithFrame:CGRectMake(ScreenWidth - 63, (17.5), (15), (15))] : [[UIImageView alloc]initWithFrame:CGRectMake(ScreenWidth - 63, kAUTOWIDTH(17.5), kAUTOWIDTH(15), kAUTOWIDTH(15))];
