 ...
 *  iPhoneX判断
 */
#define PNCisIPHONEX     ([[[UIApplication sharedApplication] delegate] window].safeAreaInsets.bottom > 0.0?YES:NO)
...
#define kIsFullScreen       ([[[UIApplication sharedApplication] delegate] window].safeAreaInsets.bottom > 0.0?YES:NO)
...
#define   CELL_Height PNCisIPAD ? 60 :  kAUTOWIDTH(60)
...
#define kNewVersion   @"kNewVersion"      //使用网络加载图片的新版本
#define kPlaceholderImage  [UIImage imageNamed:@"kongImage9.png"]    //占位图的宏定义
